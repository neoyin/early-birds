...
public class Util {
     ...
     * @return
     */
    public static String fillString(String src, int length, char fill) {
     ...
     * @return
     */
    public static String preFillString(String src, int length) {
        return preFillString(src, length, ' ');
    }
     ...
     * @return
     */
    public static String preFillString(String src, int length, char fill) {
        if (src.length() < length) {
            int delta = length - src.length();
            for (int i = 0; i < delta; i++) {
                src = fill + src;
