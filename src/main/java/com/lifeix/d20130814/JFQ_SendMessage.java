...
public class JFQ_SendMessage {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		String messageUrl = "http://www.l99.com/timeline_saveText.action";
		Map<String, String> dataMap = new HashMap<String, String>(){{put("text.ztFlag", "false");put("text.textTitle","自动发送标题");put("text.textContent","这是随笔内容");}};
		Map<String, String> map = new HashMap<String, String>(){{put("e","3289814");put("m","13893840312");}};
		JFQ_SendMessage sm = new JFQ_SendMessage();
